            ...
            <q-form @submit.prevent='submitForm' class="q-pa-md">
              ...
              <q-card flat v-for="product in form.products" :key="product._id">
                <div class="row">
                  ...
                  <div class="col-8 q-ml-md">
                    ...
                    <q-radio class="q-my-md" color="black" v-for="(size, idx) in product.product.size"
                      v-model="product.size" :val="size" :label="size" :key="idx" />
                  ...
                  <div class="col column reverse">
                    <div class="row reverse">
                      <div class="text-subtitle2 text-weight-medium q-mr-md">NT$:{{
              ...
              <div class="q-my-xxl">
                <q-btn outline class="q-py-sm q-px-xxl text-subtitle2 q-mr-md" color="black" label="取消"
                  @click='dialog = false' :disabled='form.submitting' />
