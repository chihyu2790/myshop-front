      ...
      <div class="col-10">
        ...
        >
          <q-form @submit.prevent='creatStore()' class="q-pa-md" >
            ...
            <div class="q-my-xxl">
              <q-btn outline class="q-py-sm q-px-xxl text-subtitle2 q-mr-md" color="black" label="取消" @click='resetform' :disabled='form.submitting' />
              <q-btn unelevated class="q-py-sm q-px-xxl text-subtitle2" type='submit' color="black text-white" label="新增" />
            </div>
          </q-form>
        </q-card>
      </div>
